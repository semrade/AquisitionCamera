...
/* This function will write an image from Aravis buffer */
...
int main (int argc, char **argv)
{
    ...
    if (ARV_IS_CAMERA (camera)) 
    {
        ...
        if (ARV_IS_BUFFER (buffer)) 
        {
            ...
            /* Save the buffer to image using pnglib */
            arv_save_png(buffer, "first_image.png");
...
void arv_save_png(ArvBuffer * buffer, const char * filename)
{
    ...
    printf("arv_buffer_get_payload_type = %d\n",arv_buffer_get_payload_type(buffer));
